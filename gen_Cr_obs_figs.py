...
def plot_obs(ifile_loc, plt_id, dfObs):
    ...
    fig, ax = plt.subplots(nrows=3, ncols=4, figsize=(16, 9), sharex=True, sharey=False)
...
# save fig
    # ofile = 'output/Cr_figures/Cr_obs_new_figs/Conc_obs_{}_rev.png'.format(ifile_loc)
...
if __name__ == "__main__":
    ...
    list_loc = ['AWLN_shallow_wells1.csv',
                'AWLN_shallow_wells2.csv', 'AWLN_deep_wells.csv']

...
# directories
cwd=os.getcwd()
outDir=os.path.join(cwd,'intermediate','grid_OUTPUT')
...
grid = m.dis.get_node_coordinates() #issue here is coordinates are not projected
ok = grid[2][0][92][197] #got into nodes, then into layer 1, then row 93 and col 198 zero-based index
